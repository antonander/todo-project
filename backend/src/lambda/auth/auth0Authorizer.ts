...
import { JwksKeyProperties } from '../../auth/JwtValidation'
...
const jwksUrl = 'https://dev-fdockgfp.us.auth0.com/.well-known/jwks.json'
...
async function verifyToken(authHeader: string): Promise<JwtPayload> {
  ...
  const cert: string = await getCert(jwtKid)
...
async function getCert(jwtKid: string) : Promise<string>{
  try {
